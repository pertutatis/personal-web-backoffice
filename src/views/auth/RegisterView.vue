<template>
  <div class="min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full p-6 bg-white rounded-lg shadow-md">
      ...
      <form data-test="register-form" @submit.prevent="handleSubmit" class="space-y-4">
        <!-- Email -->
        <div>
          ...
          />
          <p v-if="emailError" data-test="email-error" class="mt-1 text-sm text-red-600">
            {{ emailError }}
          </p>
        </div>
        ...
        <button
          ...
          :disabled="isLoading"
        >
          <template v-if="isLoading"> Registrando... </template>
